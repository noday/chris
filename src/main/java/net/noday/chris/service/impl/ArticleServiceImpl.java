...
import net.noday.chris.dao.ArticleDao;
import net.noday.chris.event.ArticleSaveEvent;
import net.noday.chris.model.Article;
import net.noday.chris.service.ArticleService;
import net.noday.chris.service.TagService;
...
public class ArticleServiceImpl implements ApplicationEventPublisherAware, ArticleService {
	...
	/* (non-Javadoc)
	 * @see net.noday.chris.service.impl.ArticleService#get(long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.noday.chris.service.impl.ArticleService#show(long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.noday.chris.service.impl.ArticleService#save(net.noday.chris.model.Article)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.noday.chris.service.impl.ArticleService#update(net.noday.chris.model.Article)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.noday.chris.service.impl.ArticleService#delete(java.lang.Long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.noday.chris.service.impl.ArticleService#updateTopable(java.lang.Long, boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.noday.chris.service.impl.ArticleService#listPage(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.noday.chris.service.impl.ArticleService#listPage4Tag(int, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.noday.chris.service.impl.ArticleService#findMostView(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.noday.chris.service.impl.ArticleService#findRecent(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.noday.chris.service.impl.ArticleService#findMostReply(int)
	 */
	@Override
