 ...
 */
package net.noday.chris.model.ext;
...
public class RhythmArticle implements Serializable {
	...
	public class Article implements Serializable {
		...
		public Article(net.noday.chris.model.Article a, String email) {
			super();
			setOId(a.getId()+"");
