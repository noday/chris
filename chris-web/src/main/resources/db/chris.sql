...
insert  into `user`(`id`,`email`,`password`,`name`,`sex`,`organization`,`visits`,`downloads`,`regist_time`,`regist_ip`,`last_time`,`last_ip`,`status`,`salt`,`role`) values (1,'admin@noday.net','urcwOpgSawZXsYn/GGp1VAZoPOVWjljf1RxW7HI/V0I=','noday',NULL,NULL,0,0,'2012-11-05 12:28:07','127.0.0.1',NULL,NULL,1,'Zvv8Aksp5/I=','admin');
...
insert  into `user`(`id`,`email`,`password`,`name`,`sex`,`organization`,`visits`,`downloads`,`regist_time`,`regist_ip`,`last_time`,`last_ip`,`status`,`salt`,`role`,`duoshuo_id`) values (2,'test@noday.net','Za71iPRKOkQcBkHhujI3CFwKIYTdagARJl5b92Iu8v0=','admin',NULL,NULL,0,0,'2012-11-05 12:28:07','127.0.0.1',NULL,NULL,1,'GD+GV3h1bAs=','admin',NULL);